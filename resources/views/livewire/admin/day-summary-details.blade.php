            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-1 fw-bold" style="color:#1B5E85;">
                                <i class="bi bi-calendar-check me-2" style="color:#1B5E85;"></i>Register Report - {{ \Carbon\Carbon::parse($sessionDate)->format('d/m/Y') }}
                            </h4>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 fw-bold" style="color:#1B5E85;">
                        <i class="bi bi-cash-coin me-2" style="color:#1B5E85;"></i>💰 CASH SALES
                    </h5>
                </div>
