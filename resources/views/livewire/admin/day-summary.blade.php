                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0 fw-bold" style="color:#1B5E85;">
                                <i class="bi bi-calendar-check me-2" style="color:#1B5E85;"></i>Day Summary List & Deposit by Cash
                            </h4>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3 d-flex align-items-center justify-content-between">
                    <h5 class="mb-0 fw-bold" style="color:#1B5E85;">
                        <i class="bi bi-list-ul me-2" style="color:#1B5E85;"></i>POS Sessions ({{ $sessions->total() }})
                    </h5>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr wire:click="viewDetails({{ $session->id }})"
                                    ...
                                    <td>
                                        <strong style="color:#1B5E85;">{{ \Carbon\Carbon::parse($session->session_date)->format('d/m/Y') }}</strong>
                                        <br>
                                        <small class="text-muted">{{ \Carbon\Carbon::parse($session->session_date)->format('l') }}</small>
                                    </td>
                                    <td>
                                        <i class="bi bi-person-circle me-1" style="color:#1B5E85;"></i>
                                        {{ $session->user->name ?? 'N/A' }}
                                    </td>
                                    <td>Rs.{{ number_format($session->opening_cash, 2) }}</td>
                                    <td>Rs.{{ number_format($session->closing_cash, 2) }}</td>
                                    <td>
                                        <strong style="color:#1B5E85;">Rs.{{ number_format($session->total_sales, 2) }}</strong>
                                    </td>
