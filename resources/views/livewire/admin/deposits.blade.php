                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0 fw-bold" style="color:#2563EB;">
                                <i class="bi bi-bank2 me-2" style="color:#2563EB;"></i>Deposits Management
                            </h4>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <h5 class="fw-bold mb-3" style="color:#2563EB;">
                        <i class="bi bi-wallet2 me-2" style="color:#2563EB;"></i>Today's Cash Summary
                    </h5>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="text-center p-3 rounded" style="background-color: #ffffff;">
                                <h6 class="text-muted mb-1">Opening Cash</h6>
                                <h5 class="fw-bold" style="color:#2563EB;">Rs. {{ number_format($openingCash, 2) }}</h5>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="text-center p-3 rounded" style="background-color: #fff3cd;">
                                ...
                                <h5 class="fw-bold" style="color:#2563EB;">Rs. {{ number_format($todayDepositAmount, 2) }}</h5>
                            </div>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 fw-bold" style="color:#2563EB;">
                        <i class="bi bi-list-ul me-2" style="color:#2563EB;"></i>Deposits History ({{ $deposits->total() }})
                    </h5>
                </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr wire:click="viewDeposit({{ $deposit->id }})"
                                    ...
                                    <td>
                                        <strong style="color:#2563EB;">{{ \Carbon\Carbon::parse($deposit->date)->format('d/m/Y') }}</strong>
                                        <br>
            ...
            <div class="modal-content rounded-0">
                ...
                <form wire:submit.prevent="addDeposit">
                    <div class="modal-body">
                        ...
                        <div class="p-3 mb-4 rounded-0" style="background-color: #f5fdf1ff; border: 1px solid #2563EB;">
                            <h6 class="fw-bold mb-3" style="color:#2563EB;">
                                <i class="bi bi-wallet2 me-2" style="color:#2563EB;"></i>Today's Cash Summary
                            </h6>
                            <div class="d-flex justify-content-between small mb-2">
                                <span class="text-muted">Opening Cash:</span>
                                <span class="fw-semibold" style="color:#2563EB;">Rs. {{ number_format($openingCash, 2) }}</span>
                            </div>
                            <div class="d-flex justify-content-between small mb-2">
                            ...
                            <div class="d-flex justify-content-between small mb-2">
                                ...
                                <span class="fw-semibold" style="color:#2563EB;">Rs. {{ number_format($todayDepositAmount, 2) }}</span>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold" style="color:#2563EB;">Date</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold" style="color:#2563EB;">Amount (Rs.)</label>
                        ...
                        {{-- Description --}}
                        <div class="mb-3">
                            <label class="form-label fw-semibold" style="color:#2563EB;">Description / Source</label>
                    ...
                    <div class="modal-footer border-0">
                        ...
                        <button type="submit" class="btn rounded-0" style="background: #2563EB; color:white;">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h6 class="fw-semibold" style="color:#2563EB;">Date:</h6>
                            <p>{{ \Carbon\Carbon::parse($selectedDeposit->date)->format('d M Y, l') }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-semibold" style="color:#2563EB;">Amount:</h6>
                            <p class="fw-bold text-info">Rs. {{ number_format($selectedDeposit->amount, 2) }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <h6 class="fw-semibold" style="color:#2563EB;">Description:</h6>
                            <p>{{ $selectedDeposit->description }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <h6 class="fw-semibold" style="color:#2563EB;">Created:</h6>
