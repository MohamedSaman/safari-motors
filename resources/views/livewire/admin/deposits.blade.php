<div class="container-fluid py-4" style="background-color:#f5fdf1ff;">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0 fw-bold" style="color:#1B5E85;">
                                <i class="bi bi-bank2 me-2" style="color:#1B5E85;"></i>Deposits Management
                            </h4>
                            <small class="text-muted">Manage cash deposits and view history</small>
                        </div>
                        <div>
                            <button class="btn btn-sm rounded-0" style="background: #1B5E85; color:white;" wire:click="resetFilters">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <h5 class="fw-bold mb-3" style="color:#1B5E85;">
                        <i class="bi bi-wallet2 me-2" style="color:#1B5E85;"></i>Today's Cash Summary
                    </h5>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="text-center p-3 rounded" style="background-color: #ffffff;">
                                <h6 class="text-muted mb-1">Opening Cash</h6>
                                <h5 class="fw-bold" style="color:#1B5E85;">Rs. {{ number_format($openingCash, 2) }}</h5>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center p-3 rounded" style="background-color: #d4edda;">
                                <h6 class="text-muted mb-1">Cash Sales</h6>
                                <h5 class="fw-bold text-info">Rs. {{ number_format($todayCashAmount, 2) }}</h5>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center p-3 rounded" style="background-color: #EFF6FF;">
                                <h6 class="text-muted mb-1">Deposited</h6>
                                <h5 class="fw-bold" style="color:#1B5E85;">Rs. {{ number_format($todayDepositAmount, 2) }}</h5>
                            </div>
                        </div>
                        <div class="col-md-3">
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <label class="form-label fw-semibold" style="color:#1B5E85;">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 fw-bold" style="color:#1B5E85;">
                        <i class="bi bi-list-ul me-2" style="color:#1B5E85;"></i>Deposits History ({{ $deposits->total() }})
                    </h5>
                </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr wire:click="viewDeposit({{ $deposit->id }})"
                                    ...
                                    <td>
                                        <strong style="color:#1B5E85;">{{ \Carbon\Carbon::parse($deposit->date)->format('d/m/Y') }}</strong>
                                        <br>
                                        <small class="text-muted">{{ \Carbon\Carbon::parse($deposit->date)->format('l') }}</small>
                                    </td>
                                    <td>
                                        <span class="fw-bold text-info">Rs. {{ number_format($deposit->amount, 2) }}</span>
                                    </td>
    ...
    <div class="modal fade show d-block" tabindex="-1" style="background-color: rgba(0,0,0,0.5);">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0">
                <div class="modal-header" style="background: #1B5E85; color:white;">
                ...
                <form wire:submit.prevent="addDeposit">
                    <div class="modal-body">
                        ...
                        <div class="p-3 mb-4 rounded-0" style="background-color: #f5fdf1ff; border: 1px solid #1B5E85;">
                            <h6 class="fw-bold mb-3" style="color:#1B5E85;">
                                <i class="bi bi-wallet2 me-2" style="color:#1B5E85;"></i>Today's Cash Summary
                            </h6>
                            <div class="d-flex justify-content-between small mb-2">
                                <span class="text-muted">Opening Cash:</span>
                                <span class="fw-semibold" style="color:#1B5E85;">Rs. {{ number_format($openingCash, 2) }}</span>
                            </div>
                            <div class="d-flex justify-content-between small mb-2">
                                <span class="text-muted">Today's Cash Amount:</span>
                                <span class="fw-semibold text-info">Rs. {{ number_format($todayCashAmount, 2) }}</span>
                            </div>
                            <div class="d-flex justify-content-between small mb-2">
                            ...
                            <div class="d-flex justify-content-between small mb-2">
                                ...
                                <span class="fw-semibold" style="color:#1B5E85;">Rs. {{ number_format($todayDepositAmount, 2) }}</span>
                            </div>
                            <hr style="border-color: #1B5E85;">
                            <div class="d-flex justify-content-between small">
                                <span class="text-muted fw-bold">Remaining Cash:</span>
                                <span class="fw-bold text-info">Rs. {{ number_format($openingCash + $todayCashAmount - $todayExpenses - $todayRefunds - $todayDepositAmount, 2) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold" style="color:#1B5E85;">Date</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold" style="color:#1B5E85;">Amount (Rs.)</label>
                        ...
                        {{-- Description --}}
                        <div class="mb-3">
                            <label class="form-label fw-semibold" style="color:#1B5E85;">Description / Source</label>
                    ...
                    <div class="modal-footer border-0">
                        ...
                        <button type="submit" class="btn rounded-0" style="background: #1B5E85; color:white;">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h6 class="fw-semibold" style="color:#1B5E85;">Date:</h6>
                            <p>{{ \Carbon\Carbon::parse($selectedDeposit->date)->format('d M Y, l') }}</p>
                        </div>
                        <div class="col-md-6">
                            <h6 class="fw-semibold" style="color:#1B5E85;">Amount:</h6>
                            <p class="fw-bold text-info">Rs. {{ number_format($selectedDeposit->amount, 2) }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <h6 class="fw-semibold" style="color:#1B5E85;">Description:</h6>
                            <p>{{ $selectedDeposit->description }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <h6 class="fw-semibold" style="color:#1B5E85;">Created:</h6>
